...
$listaRegistroVeiculo = select_RegistroVeiculo_Saida($conexao);
...
if($registroVeiculo['SAIDA']==null || isset($registroVeiculo['SAIDA'])==false || $registroVeiculo['SAIDA']==""){
    $pdf->Cell(55,10,"",1,0,"C");

}else{
    $pdf->Cell(55,10,$registroVeiculo['SAIDA'],1,0,"C");
